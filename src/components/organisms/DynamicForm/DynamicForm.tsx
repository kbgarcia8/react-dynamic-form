                            ...
                            ? fieldset['inputs'].map((input, inputIndex) => (
                                ...
                                <>
                                    ...
                                    {(input.editing && input.isEditable) && <NestedEditableOption
                                        ...
                                        cancelText={input.cancelText ?? undefined}
                                        cancelButtonStartIcon={input.cancelButtonStartIcon ?? undefined}
                                        cancelButtonEndIcon={input.cancelButtonEndIcon ?? undefined}
                                        deleteText={input.deleteText ?? undefined}
                                        deleteButtonStartIcon={input.deleteButtonStartIcon ?? undefined}
                                        deleteButtonEndIcon={input.deleteButtonEndIcon ?? undefined}
